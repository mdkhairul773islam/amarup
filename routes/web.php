...
Route::prefix('admin/member')->group(function () {
    Route::match(['GET','POST'], '/', [App\Http\Controllers\MemberController::class, 'index'])->name('admin.member');
...
Route::prefix('admin/bazar_member')->group(function () {
    Route::match(['GET','POST'], '/', [App\Http\Controllers\BazarMemberController::class, 'index'])->name('admin.bazar_member');
    ...
    Route::post('/ward-wise-mamber', [App\Http\Controllers\BazarMemberController::class, 'wardWiseMembers'])->name('admin.bazar_member.ward-wise-mamber');
});

// Tax Collection route
Route::prefix('admin/tax-collection')->group(function () {
    Route::match(['GET','POST'], '/', [App\Http\Controllers\TaxCollectionController::class, 'index'])->name('admin.tax-collection');
...
Route::prefix('admin/affidavit')->group(function () {
    Route::match(['GET','POST'], '/', [App\Http\Controllers\AffidavitController::class, 'index'])->name('admin.affidavit');
...
Route::prefix('admin/chairman')->group(function () {
    Route::match(['GET','POST'], '/', [App\Http\Controllers\ChairmanController::class, 'index'])->name('admin.chairman');
...
Route::prefix('admin/trade_license')->group(function () {
    Route::match(['GET','POST'], '/', [App\Http\Controllers\TradeLicenseController::class, 'index'])->name('admin.trade_license');
