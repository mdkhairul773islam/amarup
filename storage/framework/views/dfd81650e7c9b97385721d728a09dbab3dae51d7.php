            ...
            <div class="panel_container">
                ...
                <div class="panel_body">
                    ...
                    <div class="notice_title">
                        <p>স্মারক নংঃ <?php echo e((!empty($info->memorial_no) ? numberFilter($info->memorial_no,'bn') : "")); ?></p>
                        <p>তারিখঃ <?php echo e((!empty($info->created) ? numberFilter($info->created,'bn') : "")); ?></p>
                    </div>
                    ...
                    <div class="notice_sub">
                        ...
                        <p><strong>সূত্রঃ <?php echo e((!empty($info->formula) ? numberFilter($info->formula,'bn') : " ")); ?> ।</strong></p>
                    ...
                    <div class="notice_article">
                        <p class="normal_text">
                            ...
                            <strong><?php echo e($union->bn_name); ?></strong> ইউনিয়ন পরিষদের আওতাধীন সকল অফিস, 
                            ...
                            করার বিধান রয়েছে।
                            <strong style="text-decoration: underline;"><?php echo e((!empty($info) ? numberFilter($info->holding_no,'bn') : " ")); ?></strong>
                            নং হোল্ডিং অনুসারে  বাৎসরিক আরোপিত করের পরিমাণ 
                            <strong style="text-decoration: underline;"><?php echo e((!empty($info) ? numberFilter($info->annual_assessment,'bn') : " ")); ?></strong>
                            টাকা। বিগত
                            <strong style="text-decoration: underline;"><?php echo e(numberFilter(date("Y", strtotime($info->created))-1,'bn')); ?></strong>
                            সাল হতে হালনাগাদ সর্বমোট 
                            <strong style="text-decoration: underline;"><?php echo e(numberFilter($info->balance,'bn')); ?></strong>
                            টাকা পরিশোধযোগ্য ।
                        </p>
                    ...
                    <div class="footer_signature">
                        <div class="signature_box">
                            <p><strong>প্রাপকঃ </strong>  <?php echo e($info->name); ?></p>
                            
                            <?php if(!empty($info)) { ?>
                            <p>
                                <?php echo e((!empty($union) ? $union->bn_name : " ")); ?>,
                                <?php echo e((!empty($upazila) ? $upazila->bn_name : " ")); ?>, <br>
                        ...
                        <div class="signature_box">
                            ...
                            <?php if(!empty($chairmans)) { ?>
                                ...
                                <p><?php echo e((!empty($union_name) ? $union_name->bn_name : " ")); ?> ইউনিয়ন পরিষদ কার্যালয়</p>
                                    <p>
                                        <?php echo e((!empty($upazila_name) ? $upazila_name->bn_name : " ")); ?>,
                                        <?php echo e((!empty($district_name) ? $district_name->bn_name : " ")); ?>।
                                    </p>
                            <?php }else{ ?>
                                <p>&nbsp;</p>
                                <p><strong>চেয়ারম্যান</strong></p>
                                <p><?php echo e((!empty($union) ? $union->bn_name : " ")); ?> ইউনিয়ন পরিষদ কার্যালয়</p>
                                <p>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kajodrsv/amaruptax.com/resources/views/notice/view.blade.php ENDPATH**/ ?>