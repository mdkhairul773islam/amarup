            ...
            <div class="panel_container">
                ...
                <div class="panel_body">
                    <div class="repot_header print_only">
                        ...
                        <h4><?php echo e($wards->where('id', $_POST['ward_id'])->first()->name_bn); ?></h4>
                        <?php endif; ?>
                        <h4></h4>
                    </div>
                    
                    <form action="<?php echo e(route('admin.reports.ward')); ?>" method="post" class="d-print-none">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            ...
                            <tbody>
                                ...
                                <?php ($ward = $wards->where('id', $row->ward_id)->first()); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($row->settlement_type); ?></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kajodrsv/amaruptax.com/resources/views/reports/ward.blade.php ENDPATH**/ ?>