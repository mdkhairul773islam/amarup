                    ...
                    <form action="<?php echo e(route('admin.affidavit.store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input inputmode="numeric" pattern="[0-9]*" type="text" name="affidavit_no" value="" class="form-control" >
                                </div>
                            </div>
...
<?php $__env->startPush('footer-script'); ?>
    <script>
        ...
        $('#memberId').on('change', function(){
            ...
            $.ajax({
                method : "POST",
                url    : "<?php echo e(route('admin.notice.member-info')); ?>",
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kajodrsv/amaruptax.com/resources/views/affidavit/create.blade.php ENDPATH**/ ?>