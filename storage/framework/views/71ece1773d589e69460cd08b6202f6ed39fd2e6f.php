                ...
                <div class="panel_body">
                    <div class="trade_license position-relative">
                        <div class="position-absolute justify-content-center align-items-center h-100 w-100 bg_photo">
                            <img class="bg_img" src="<?php echo e(asset('public/license/govbd.png')); ?>" alt="Photo Not Found!">
                        </div>
                        ...
                        <div class="print_header_info print_only">
                            ...
                            <div class="row justify-content-end">
                                <div class="col-4">
                                    <img class="govbd" src="<?php echo e(asset('public/license/govbd.png')); ?>" alt="Photo Not Found!">
                                </div>
                                <div class="col-4">
                                    <img class="mujib" src="<?php echo e(asset('public/license/mujib.png')); ?>" alt="Photo Not Found!">
                                </div>
                            </div>
                            ...
                            <h4><?php echo e((!empty($union_name) ? $union_name->bn_name : " ")); ?>  ইউনিয়ন পরিষদ কার্যালয়</h4>
                            <h4><?php echo e((!empty($upazilas_name) ?  $upazilas_name->bn_name : " ")); ?>, <?php echo e((!empty($districts_name) ? $districts_name->bn_name : " ")); ?></h4>
                            ...
                            <div class="row">
                                <div class="col col-sm-5">
                                    <p>
                                        ...
                                        <?php echo e(numberFilter($info->license_no,'bn')); ?>
                                ...
                                <div class="col">
                                    <p>
                                        ...
                                        <?php echo e(numberFilter($info->finance_year,'bn')); ?>
                                ...
                                <div class="col col-sm-3">
                                    <p>
                                        ...
                                        <?php echo e(numberFilter($info->created,'bn')); ?>
                                ...
                                <div class="table-responsive" style="margin: 0 4px;">
                                    <table class="table table-bordered">
                                        <tr>
                                            ...
                                            <td colspan="4"> <?php echo e($info->business_name); ?> </td>
                                        </tr>
                                        <tr>
                                            <th>স্বত্বাধিকারী/লাইসেন্সধারীর নাম</th>
                                            <th class="text-center">:</th>
                                            <td colspan="4"> <?php echo e($info->license_owner); ?> </td>
                                        </tr>
                                        <tr>
                                            <th>পিতা/স্বামী</th>
                                            <th class="text-center">:</th>
                                            <td colspan="4"> <?php echo e($info->father_name); ?> </td>
                                        </tr>
                                        <tr>
                                            <th>মাতা</th>
                                            <th class="text-center">:</th>
                                            <td colspan="4"> <?php echo e($info->mother_name); ?> </td>
                                        </tr>
                                        <tr>
                                            <th>মোবাইল নাম্বার</th>
                                            <th class="text-center">:</th>
                                            <td colspan="4"> <?php echo e($info->mobile); ?> </td>
                                        </tr>
                                        <tr>
                                            <th>জাতীয় পরিচয়পত্র নম্বর</th>
                                            <th class="text-center">:</th>
                                            <td colspan="4"> <?php echo e(numberFilter($info->nid,'bn')); ?> </td>
                                        </tr>
                                        <tr>
                                            <th>ঠিকানা</th>
                                            <th class="text-center">:</th>
                                            <td colspan="4"> <?php echo e($info->address); ?> </td>
                                        </tr>
                                        <tr>
                                            <th>ব্যবসা প্রতিষ্ঠানের ঠিকানা</th>
                                            <th class="text-center">:</th>
                                            <td colspan="4"> <?php echo e($info->business_address); ?> </td>
                                        </tr>
                                        <tr>
                                            <th>ব্যবসার/পেশার ধরণ</th>
                                            <th class="text-center">:</th>
                                            <td colspan="4"> <?php echo e($info->business_type); ?> </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <th>লাইসেন্স ফি</th>
                                            <th width="3%" class="text-center">:</th>
                                            <td class="text-right"> <?php echo e(numberFilter($info->license_fee,'bn')); ?> </td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <th></th>
                                            ...
                                            <th>ভ্যাট</th>
                                            <th class="text-center">:</th>
                                            <td class="text-right"> <?php echo e(numberFilter($info->vat,'bn')); ?> </td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <th></th>
                                            ...
                                            <th class="text-center">:</th>
                                            <td class="text-right"> <?php echo e(numberFilter($info->tax_2,'bn')); ?> </td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <th></th>
                                            ...
                                            <th>সার্ভিস চার্জ</th>
                                            <th class="text-center">:</th>
                                            <td class="text-right"> <?php echo e(numberFilter($info->service_charge,'bn')); ?> </td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <th></th>
                                            ...
                                            <th class="text-center"></th>
                                            <th class="text-right"> <?php echo e(numberFilter($info->total,'bn')); ?> </th>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            <th>কথায়</th>
                                            <th class="text-center">:</th>
                                            <td colspan="4" style="text-transform: capitalize;"><?php echo e($obj->numToWord($info->total)); ?> টাকা মাত্র।</td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">:</th>
                                            <td colspan="4">
                                                <?php echo e(numberFilter($info->validity_period,'bn')); ?>
                        ...
                        <div class="footer_signature">
                            <div class="signature_box">
                                ...
                                <?php if(!empty($ministers)) { ?>
                                    <p><?php echo e((!empty($ministers) ? $ministers->minister : "")); ?></p>
                                    ...
                                    <p><?php echo e((!empty($union) ? $union->bn_name : " ")); ?> ইউনিয়ন পরিষদ কার্যালয়</p>
                                    <p>
                                ...
                                <p>&nbsp;</p>
                                <p><strong>সচিব</strong></p>
                                <p><?php echo e((!empty($union_name) ? $union_name->bn_name : " ")); ?> ইউনিয়ন পরিষদ কার্যালয়</p>
                                <p><?php echo e((!empty($upazilas_name) ? $upazilas_name->bn_name : " ")); ?>, <?php echo e((!empty($districts_name) ? $districts_name->bn_name : " ")); ?>।</p>
                            ...
                            <div class="signature_box">
                                ...
                                <?php if(!empty($chairmans)) { ?>
                                    <p><?php echo e((!empty($chairmans) ? $chairmans->chairman : "")); ?></p>
                        ...
                        <!--<div class="row footer_middle">
                            <div class="col-sm-9">
                                <p>সনদ যাচাইঃ</p>
                                <p>ক)&nbsp;&nbsp;&nbsp;&nbsp; <?php echo e(numberFilter($info->license_no,'bn')); ?> লিখে SMS করুন ৯৯৯৯৯ নাম্বারে।</p>
                                <p>খ)&nbsp;&nbsp;&nbsp;&nbsp; ভিজিট করুন: <a href="https://amaruptax.com/" class="btn-link">amaruptax.com</a></p>
                                <p>গ)&nbsp;&nbsp;&nbsp;&nbsp; QR স্ক্যান করুন।</p>
                            </div>
                            <div class="col-sm-3">
                                <img class="qr_code" src="<?php echo e(asset('public/license/qr_code.webp')); ?>" alt="Photo Not Found!">
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kajodrsv/amaruptax.com/resources/views/trade_license/view.blade.php ENDPATH**/ ?>