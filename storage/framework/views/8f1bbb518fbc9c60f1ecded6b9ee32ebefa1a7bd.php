...
<div class="body_nav">
    <ul>
        ...
        <li><a class="addAffidavit" href="<?php echo e(route('admin.affidavit.create')); ?>">নতুন সনদ পত্র</a></li>
        <?php endif; ?>
        ...
        <li><a class="allAffidavit" href="<?php echo e(route('admin.affidavit')); ?>" >সকল সনদ পত্র</a></li>
        <?php endif; ?>
    </ul>
</div>
<!-- body nav start -->
<?php /**PATH /home/kajodrsv/amaruptax.com/resources/views/affidavit/citizenship_certificate_nav.blade.php ENDPATH**/ ?>