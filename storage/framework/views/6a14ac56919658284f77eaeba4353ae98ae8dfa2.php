        ...
        <div class="body_content">
            <div class="panel_container">
                <div class="panel_heading">
                    <h4>দৈনিক ট্যাক্স সংগ্রহ রিপোর্ট</h4>
                ...
                <div class="panel_body">
                    ...
                    <div class="repot_header print_only">
                        ...
                        <h4>ওয়ার্ড : <?php echo e(numberFilter($_POST['ward_id'],'bn')); ?></h4>
                        <?php endif; ?>
                    </div>
                    
                    <form action="<?php echo e(route('admin.reports.collection')); ?>" method="post" class="d-print-none">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                        ...
                        <table class="table table-bordered" id="DataTable">
                            ...
                            <tbody>
                                ...
                                <?php if(!empty($results) && $results->isNotEmpty()): ?>
                                    ...
                                    <tr>
                                        <td class="text-center"><?php echo e(numberFilter(++$key,'bn')); ?></td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kajodrsv/amaruptax.com/resources/views/reports/collection.blade.php ENDPATH**/ ?>