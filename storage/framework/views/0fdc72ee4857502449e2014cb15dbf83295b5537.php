                                ...
                                <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="operation_btn text-right print_hide">
                                            <?php //if(($privilege == 'super') ||  (!empty($accessList->affidavit->submenu->action->view) && $accessList->affidavit->submenu->action->view == "view")) { ?>
                                                <a href="<?php echo e(route('admin.affidavit.view', $row->id)); ?>" class="view" title="View">
                                                    <i class="far fa-eye" aria-hidden="true"></i>
                                                </a>
                                            <?php //}
                                           //if(($privilege == 'super') ||  (!empty($accessList->affidavit->submenu->action->edit) && $accessList->affidavit->submenu->action->edit == "edit")) { ?>
                                            <a href="<?php echo e(route('admin.affidavit.edit', $row->id)); ?>" class="edit" title="Edit">
                                                <i class="far fa-edit" aria-hidden="true"></i>
                                            </a>
                                            <?php //}
                                            //if(($privilege == 'super') ||  (!empty($accessList->affidavit->submenu->action->delete) && $accessList->affidavit->submenu->action->delete == "delete")) { ?>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kajodrsv/amaruptax.com/resources/views/affidavit/index.blade.php ENDPATH**/ ?>