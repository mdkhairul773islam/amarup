        ...
        <div class="body_content">
            <div class="panel_container">
                ...
                <div class="panel_body">
                    ...
                    <form action="<?php echo e(route('admin.reports.member')); ?>" method="post" class="d-print-none">
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kajodrsv/amaruptax.com/resources/views/reports/member.blade.php ENDPATH**/ ?>