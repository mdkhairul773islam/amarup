                ...
                <div class="panel_body">
                    ...
                    <form action="{{$action}}" method="post" class="d-print-none">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <select name="ward_id" id="wardId" class="form-control selectpicker" data-live-search="true">
                                ...
                                @foreach($results as $key => $row)
                                    ...
                                    <tr>
                                        ...
                                        <td class="operation_btn text-right print_hide">
                                            {{--@if( ($privilege == 'super') || (!empty($accessList->bazar_member->submenu->action->view) && $accessList->bazar_member->submenu->action->view == "view"))--}}
                                                <a href="{{route('admin.bazar_member.view', $row->id)}}" class="view" title="View">
                                                    <i class="far fa-eye" aria-hidden="true"></i>
                                                </a>
                                            {{--@endif
                                            @if( ($privilege == 'super') || (!empty($accessList->bazar_member->submenu->action->edit) && $accessList->bazar_member->submenu->action->edit == "edit"))--}}
                                                <a href="{{route('admin.bazar_member.edit', $row->id)}}" class="edit" title="Edit">
                                                    <i class="far fa-edit" aria-hidden="true"></i>
                                                </a>
                                            {{--@endif
                                            @if( ($privilege == 'super') || (!empty($accessList->bazar_member->submenu->action->delete) && $accessList->bazar_member->submenu->action->delete == "delete"))--}}
