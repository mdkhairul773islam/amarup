                ...
                <ul class="aside_nav">
                    ...
                    <li id="member" class="dropdown">
                        ...
                        <ul>
                            ...
                            <li class="addMember"><a href="{{route('admin.member.create')}}">নতুন সদস্য</a></li>
                            @endif
                            
                            @if(($privilege == 'super') ||  ( !empty($accessList->member->submenu->all_member) && $accessList->member->submenu->all_member == "all_member"))
                            <li class="allMember"><a href="{{route('admin.member')}}">সকল সদস্য</a></li>
                            @endif
                        </ul>
                    </li>
                    @endif
                    ...
                    <li id="tax_collection" class="dropdown">
                        ...
                        <ul>
                            ...
                            <li class="addTaxCollection"><a href="{{route('admin.tax-collection.create')}}">নতুন কর-সংগ্রহ করুন</a></li>
                            @endif
                    ...
                    <li id="affidavit" class="dropdown">
                        ...
                        <ul>
                            ...
                            <li class="citizenshipCertificate"><a href="{{route('admin.affidavit.create')}}"> নাগরিকত্ব সনদ পত্র </a></li>
                            @endif
                        </ul>
                    </li>
                    @endif
                    ...
                    <li id="report" class="dropdown">
                        ...
                        <ul>
                            ...
                            <li class="taxReport"><a href="{{route('admin.reports.tax')}}">সকল ট্যাক্স রিপোর্ট</a></li>
                            @endif
